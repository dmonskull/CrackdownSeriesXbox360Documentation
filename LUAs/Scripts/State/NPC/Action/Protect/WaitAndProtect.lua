----------------------------------------------------------------------
-- Name: WaitAndProtect State
--	Description: Protect for a specified period of time
-- Owner: Nathan
...
WaitAndProtect = Create (Protect, 
{
	sStateName = "WaitAndProtect",
})

function WaitAndProtect:OnEnter ()
	-- Call parent
	Protect.OnEnter (self)
...
function WaitAndProtect:OnEvent (tEvent)
	...
	-- Call parent
	return Protect.OnEvent (self, tEvent)
end
