----------------------------------------------------------------------
-- Name: SportsComplexGangZone State
...
SportsComplexGangZone = Create (State, 
{
	sStateName = "SportsComplexGangZone",
})

function SportsComplexGangZone:OnEnter ()
	-- Call parent
	State.OnEnter (self)
...
function SportsComplexGangZone:OnEvent (tEvent)
	...
	elseif tEvent:HasID (self.nSportsComplexEventID) and tEvent:HasCustomEventID ("StateFinished") then
...
function SportsComplexGangZone:SetInfluence ()
