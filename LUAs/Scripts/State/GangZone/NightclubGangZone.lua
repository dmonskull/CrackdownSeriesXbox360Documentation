----------------------------------------------------------------------
-- Name: 
-- Description: Gang zone for the Nightclub area
...
NightclubGangZone = Create (State, 
{
	sStateName = "NightclubGangZone",
})

function NightclubGangZone:OnEnter ()

AILib.Emit ("NightclubGangZone function running!!")
	-- Call parent
	State.OnEnter (self)
...
--function NightclubGangZone:OnEvent (tEvent)
...
--	elseif tEvent:HasID (self.nNightclubEventID) and tEvent:HasCustomEventID ("StateFinished") then
--
...
--function NightclubGangZone:SetInfluence ()
