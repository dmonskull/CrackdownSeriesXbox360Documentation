----------------------------------------------------------------------
-- Name: IntelComplexGangZone State
...
IntelComplexGangZone = Create (State, 
{
	sStateName = "IntelComplexGangZone",
})

function IntelComplexGangZone:OnEnter ()
	-- Call parent
	State.OnEnter (self)
...
function IntelComplexGangZone:OnEvent (tEvent)
	...
	elseif tEvent:HasID (self.nIntelComplexEventID) and tEvent:HasCustomEventID ("StateFinished") then
...
function IntelComplexGangZone:SetInfluence ()
