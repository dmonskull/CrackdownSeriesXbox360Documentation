...
GarageGangZone = Create (State, 
{
	sStateName = "GarageGangZone",
})

function GarageGangZone:OnEnter ()
	-- Call parent
	State.OnEnter (self)
...
function GarageGangZone:OnEvent (tEvent)
	...
	elseif tEvent:HasID (self.nGarageEventID) and tEvent:HasCustomEventID ("StateFinished") then
...
function GarageGangZone:SetInfluence ()
