----------------------------------------------------------------------
-- Name: GangPatrolsGangZone State
...
GangPatrolsGangZone = Create (State, 
{
	sStateName = "GangPatrolsGangZone",
})

function GangPatrolsGangZone:OnEnter ()
	-- Call parent
	State.OnEnter (self)
...
function GangPatrolsGangZone:OnEvent (tEvent)
	...
	elseif tEvent:HasID (self.nGangPatrolsEventID) and tEvent:HasCustomEventID ("StateFinished") then
...
function GangPatrolsGangZone:SetInfluence ()
