...
require "State\\Crime\\GangHarassment\\Harass"
require "State\\Crime\\GangHarassment\\Taunt"
require "State\\Crime\\GangHarassment\\Victim"
...
function Crime:OnEnter ()
	...
	for i, tGangMember in pairs (self.atGangMember) do
		...
		if tGangMember == self.tHarasser then
			tGangMember:SetState (Create (Harass,
			{
